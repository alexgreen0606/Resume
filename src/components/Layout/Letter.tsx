...
const Letter: React.FC<LetterProps> = ({ letterConfig, onClose, docFolderName }) => {
    ...
    return (
        <LoadingDataContainer
            loadedData={[letterContent, authorAvatarImagePath]}
            display={
                <Card title='Letter of Recommendation' onClose={onClose} noMargins popupCard={true} width='100%' height='100%'>
                        ...
                        <Box className='authorAndDate' >
                            <Box className='verticallyCenteredRow standardBottomMargin'>
                                <Avatar
                                    ...
                                    src={authorAvatarImagePath || undefined}
