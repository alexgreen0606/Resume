...
const defaultContext: ThemeContextType = {
    ...
    typography: {
        ...
        content: { fontFamily: 'Open Sans', fontSize: 'clamp(12px, 3vw, 20px)', lineHeight: 'clamp(14px, 3.5vw, 26px)', color: darkPalette.passiveText, margin: 0 },
...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
    ...
    const typography: Typography = {
        ...
        content: { fontFamily: 'Open Sans', fontSize: 'clamp(12px, 3vw, 20px)', lineHeight: 'clamp(16px, 3.5vw, 26px)', color: currentPalette.passiveText, margin: 0 },
